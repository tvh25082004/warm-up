...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#develop-web-game)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#skill-paths-set-once)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#workflow)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#test-checklist)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#test-artifacts-to-review)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#core-game-guidelines)

### Canvas + Layout

[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#canvas--layout)

* Prefer a single canvas centered in the window.

### Visuals

[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#visuals)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#text-state-output-render_game_to_text)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#time-stepping-hook)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#fullscreen-toggle)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#progress-tracking)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#playwright-prerequisites)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#scripts)
...
[](https://github.com/openai/skills/blob/main/skills/.curated/develop-web-game/SKILL.md#references)
